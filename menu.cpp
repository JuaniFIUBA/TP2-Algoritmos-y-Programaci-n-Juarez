...
{
    cout << "Bienvenido a la reserva soñada..." << endl;
...
{
    cout << "Ingrese un tamaño (en minúsculas): (diminuto, pequeño, mediano, grande o gigante)" << endl;
    getline(cin, tamanio);
    if(!verificar_dato<string>(tamanio, (string*)TAMANIOS, CANTIDAD_TAMANIOS))
    {
        cout << "El tamaño <" << tamanio << "> ingresado es inválido." << endl;
        return false;
    }
    return true;
}
